...
<p align="center">
  <img src="assets/how-the-gate-works-en.png" alt="AI 1 writes a plan, GATE before work, AI 2 checks read-only" width="920">
</p>

AI 1 writes a **plan**. **GATE** before work. AI 2 **checks** (read-only). Notes go back.
